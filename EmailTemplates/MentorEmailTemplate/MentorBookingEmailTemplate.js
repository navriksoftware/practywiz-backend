...
export const mentorAppointmentBookedTraineeEmailTemplate = (
  mentorEmail,
  menteeName,
  mentorName,
  date,
...
>
  ...
  >
    ...
    <p style="font-size: 16px; line-height: 1.5; color: #333333;">
      Congratulations! Your booked session with <b>${menteeName}</b> has been accepted. You can attend the session as scheduled:
    </p>
    <p style="font-size: 16px; line-height: 1.5; color: #333333;">
      <b>Date:</b> ${date}<br>
      <b>Time:</b> ${slotTime}
